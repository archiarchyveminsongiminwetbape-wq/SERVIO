...
export default function ProviderProfilePage() {
  ...
  return (
    <div className="animate-fade-in" dir={isRTL ? 'rtl' : 'ltr'}>
      {/* Banner */}
      <div className="relative h-40 sm:h-48 md:h-56 overflow-hidden bg-neutral-200">
        {provider.banner_url && (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Profile header */}
        <div className="relative -mt-12 sm:-mt-16 flex flex-col gap-4 sm:flex-row sm:items-end">
