...
const FAQ_KNOWLEDGE_BASE: KnowledgeIntent[] = [
  ...
  { keywords: ['paiement', 'payer', 'carte', 'flutterwave', 'mobile', 'money'], examples: ['comment payer', 'ma carte est refusee', 'payer avec mobile money'], answer: 'Les moyens de paiement disponibles dépendent de votre région et sont affichés lors de la réservation. Le paiement est traité de façon sécurisée par Flutterwave (carte, Orange Money, MTN Money).' },
